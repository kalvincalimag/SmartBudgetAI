          ...
          <div className="rounded-2xl border border-indigo-600 p-6 shadow-md hover:shadow-lg ring-1 ring-indigo-600 sm:order-last sm:px-8 lg:p-12">
            ...
            <ul className="mt-6 space-y-2">
              <li className="flex items-center gap-1">
                ...
                <span className="text-gray-700"> All in Basic Plan </span>
              </li>
              ...
              <li className="flex items-center gap-1">
                ...
                <span className="text-gray-700"> Spending Visualization </span>
              </li>
              ...
              <li className="flex items-center gap-1">
                ...
                <span className="text-gray-700"> Tailored Financial Advice </span>
              </li>
          ...
          <div className="rounded-2xl border border-gray-200 p-6 shadow-md hover:shadow-lg sm:px-8 lg:p-12">
            ...
            <ul className="mt-6 space-y-2">
              <li className="flex items-center gap-1">
                ...
                <span className="text-gray-700"> Income Tracking </span>
              </li>
              ...
              <li className="flex items-center gap-1">
                ...
                <span className="text-gray-700"> Expense Logging </span>
              </li>
              ...
              <li className="flex items-center gap-1">
                ...
                <span className="text-gray-700"> Budget Categorization </span>
              </li>
